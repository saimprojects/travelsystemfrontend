// ── SVG icon strings (inline, no emoji) ────────────────────────────────────
export const IC = {
  phone:    '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 14.1 19.79 19.79 0 0 1 1.58 5.5 2 2 0 0 1 3.54 3.29h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.63 11.1a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.73 18.18z"/></svg>',
  email:    '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>',
  location: '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13S3 17 3 10a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>',
  plane:    '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"/></svg>',
  home:     '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9z"/><polyline points="9,22 9,12 15,12 15,22"/></svg>',
  user:     '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>',
  doc:      '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>',
  clip:     '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/></svg>',
  card:     '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>',
  check:    '<svg style="display:inline;vertical-align:middle;margin-right:3px" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',
  warning:  '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',
  ok:       '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',
  print:    '<svg style="display:inline;vertical-align:middle;margin-right:6px" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>',
  download: '<svg style="display:inline;vertical-align:middle;margin-right:6px" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>',
  clock:    '<svg style="display:inline;vertical-align:middle;margin-right:4px" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',
};

// Helper: build inclusions + duration sub-rows below service name in table
export const buildServiceMeta = (invoiceData, color = "#64748b") => {
  let html = "";
  if (invoiceData.serviceDuration) {
    html += `<div style="font-size:11px;color:${color};margin-top:4px">${IC.clock}<strong>Duration:</strong> ${invoiceData.serviceDuration}</div>`;
  }
  if (Array.isArray(invoiceData.serviceInclusions) && invoiceData.serviceInclusions.length) {
    html += `<div style="font-size:11px;color:${color};margin-top:3px;line-height:1.8">${invoiceData.serviceInclusions.map(i => `<span style="margin-right:10px">${IC.check}${i}</span>`).join("")}</div>`;
  }
  return html;
};
...
export const buildClassicTemplate = (invoiceData) => `<!DOCTYPE html><html lang="en"><head>
  ...
  <div class="wrap">
    ...
    <div class="contact-strip">
      ${invoiceData.agencyPhone ? `<span>${IC.phone}${invoiceData.agencyPhone}</span>` : ""}
      ${invoiceData.agencyEmail ? `<span>${IC.email}${invoiceData.agencyEmail}</span>` : ""}
      ${invoiceData.agencyAddress ? `<span>${IC.location}${invoiceData.agencyAddress}</span>` : ""}
    </div>
    <div class="body">
      <div class="meta-row">
        <div class="meta-box">
          ...
          ${invoiceData.clientPhone ? `<p>${IC.phone}${invoiceData.clientPhone}</p>` : ""}
          ${invoiceData.clientAltPhone ? `<p>${IC.phone}${invoiceData.clientAltPhone} (Alt)</p>` : ""}
          ${invoiceData.clientEmail ? `<p>${IC.email}${invoiceData.clientEmail}</p>` : ""}
          ${invoiceData.clientAddress ? `<p>${IC.location}${invoiceData.clientAddress}</p>` : ""}
        </div>
        <div class="meta-box">
      ...
      <table>
        ...
        <tbody>
          <tr><td><strong>${invoiceData.serviceName}</strong>${buildServiceMeta(invoiceData, "#64748b")}</td><td>1</td><td>PKR ${invoiceData.servicePrice.toLocaleString()}</td><td>PKR ${invoiceData.servicePrice.toLocaleString()}</td></tr>
        </tbody>
      </table>
      <div class="totals">
...
export const buildGoldVoucherTemplate = (invoiceData) => `<!DOCTYPE html><html lang="en"><head>
  <meta charset="UTF-8"><title>Invoice ${invoiceData.invoiceNo}</title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
  ...
  <div class="wrap">
    ...
    <div class="info-grid">
      <div class="info-box">
        <div class="info-box-header"><div class="icon-circle">${IC.clip}</div><span>Booking Information</span></div>
        <div class="info-row"><div class="icon-sm">${IC.user}</div><span class="info-label">Client :</span><span class="info-val"><strong>${invoiceData.clientName}</strong></span></div>
        ${invoiceData.clientPhone ? `<div class="info-row"><div class="icon-sm">${IC.phone}</div><span class="info-label">Phone :</span><span class="info-val">${invoiceData.clientPhone}</span></div>` : ""}
        ${invoiceData.clientAltPhone ? `<div class="info-row"><div class="icon-sm">${IC.phone}</div><span class="info-label">Alt Phone :</span><span class="info-val">${invoiceData.clientAltPhone}</span></div>` : ""}
        ${invoiceData.clientEmail ? `<div class="info-row"><div class="icon-sm">${IC.email}</div><span class="info-label">Email :</span><span class="info-val">${invoiceData.clientEmail}</span></div>` : ""}
        ${invoiceData.clientAddress ? `<div class="info-row"><div class="icon-sm">${IC.location}</div><span class="info-label">Address :</span><span class="info-val">${invoiceData.clientAddress}</span></div>` : ""}
      </div>
      <div class="info-box">
        <div class="info-box-header"><div class="icon-circle">${IC.doc}</div><span>Invoice Details</span></div>
        ...
        <div class="info-row"><div class="icon-sm">${IC.doc}</div><span class="info-label">Invoice No :</span><span class="info-val">${invoiceData.invoiceNo}</span></div>
        ${invoiceData.departureDate ? `<div class="info-row"><div class="icon-sm">${IC.plane}</div><span class="info-label">Departure :</span><span class="info-val">${invoiceData.departureDate}</span></div>` : ""}
        ${invoiceData.arrivalDate ? `<div class="info-row"><div class="icon-sm">${IC.home}</div><span class="info-label">Arrival :</span><span class="info-val">${invoiceData.arrivalDate}</span></div>` : ""}
        <div class="info-row"><div class="icon-sm">${IC.card}</div><span class="info-label">Status :</span><span class="info-val">${buildStatusBadge(invoiceData.paymentStatus)}</span></div>
      </div>
    </div>
    ...
    <table>
      ...
      <tbody><tr><td><strong>${invoiceData.serviceName}</strong>${buildServiceMeta(invoiceData, "#78350f")}</td><td>1</td><td>PKR ${invoiceData.servicePrice.toLocaleString()}</td><td><strong>PKR ${invoiceData.servicePrice.toLocaleString()}</strong></td></tr></tbody>
    </table>
...
export const buildDarkProTemplate = (invoiceData) => `<!DOCTYPE html><html lang="en"><head>
  <meta charset="UTF-8"><title>Invoice ${invoiceData.invoiceNo}</title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    @page{size:A4 portrait;margin:12mm}
  ...
  <div class="wrap">
    ...
    <div class="meta-section">
      <div class="bill-to">
        ...
        ${invoiceData.clientPhone ? `<div class="client-info">${IC.phone}${invoiceData.clientPhone}${invoiceData.clientAltPhone ? " &nbsp;|&nbsp; " + invoiceData.clientAltPhone : ""}</div>` : ""}
        ${invoiceData.clientEmail ? `<div class="client-info">${IC.email}${invoiceData.clientEmail}</div>` : ""}
        ${invoiceData.clientAddress ? `<div class="client-info">${IC.location}${invoiceData.clientAddress}</div>` : ""}
      </div>
    ...
    <table>
      <thead><tr><th>Item / Service Description</th><th>Duration</th><th>Rate</th><th>Amount</th></tr></thead>
      <tbody><tr><td><strong>${invoiceData.serviceName}</strong>${buildServiceMeta(invoiceData, "#9ca3af")}</td><td>${invoiceData.serviceDuration || "—"}</td><td>PKR ${invoiceData.servicePrice.toLocaleString()}</td><td><strong>PKR ${invoiceData.servicePrice.toLocaleString()}</strong></td></tr></tbody>
    </table>
...
export const buildMinimalTemplate = (invoiceData) => `<!DOCTYPE html><html lang="en"><head>
  <meta charset="UTF-8"><title>Invoice ${invoiceData.invoiceNo}</title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
  ...
  <div class="wrap">
    ...
    <table>
      ...
      <tbody><tr><td><strong>${invoiceData.serviceName}</strong>${buildServiceMeta(invoiceData, "#a1a1aa")}</td><td>1</td><td>PKR ${invoiceData.servicePrice.toLocaleString()}</td><td>PKR ${invoiceData.servicePrice.toLocaleString()}</td></tr></tbody>
    </table>
    <div class="subtotals">
...
export const buildCorporateTemplate = (invoiceData) => `<!DOCTYPE html><html lang="en"><head>
  <meta charset="UTF-8"><title>Invoice ${invoiceData.invoiceNo}</title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
  ...
  <div class="wrap">
    ...
    <div class="body">
      <div class="info-row">
        <div class="info-card">
          <h3>${IC.user} Client Information</h3>
          <p><strong>${invoiceData.clientName}</strong></p>
          ${invoiceData.clientPhone ? `<p>${IC.phone}${invoiceData.clientPhone}</p>` : ""}
          ${invoiceData.clientAltPhone ? `<p>${IC.phone}${invoiceData.clientAltPhone} (Alt)</p>` : ""}
          ${invoiceData.clientEmail ? `<p>${IC.email}${invoiceData.clientEmail}</p>` : ""}
      ...
      <table>
        ...
        <tbody><tr><td><strong>${invoiceData.serviceName}</strong>${buildServiceMeta(invoiceData, "#0f766e")}</td><td>1</td><td>PKR ${invoiceData.servicePrice.toLocaleString()}</td><td><strong>PKR ${invoiceData.servicePrice.toLocaleString()}</strong></td></tr></tbody>
      </table>
...
export const buildInvoiceHTML = (invoiceData, template = 'classic') => {
  switch (template) {
    case 'gold_voucher': return buildGoldVoucherTemplate(invoiceData);
    case 'dark_pro':     return buildDarkProTemplate(invoiceData);
    case 'minimal':      return buildMinimalTemplate(invoiceData);
    case 'corporate':    return buildCorporateTemplate(invoiceData);
    default:             return buildClassicTemplate(invoiceData);
  }
};
