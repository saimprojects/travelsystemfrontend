...
//         await Promise.all([
//           bookingsAPI.getBookings(bookingsParams),
...
//       try {
//         console.log("🔄 Fetching agency data for invoice...");
//         const agencyRes = await agencyAPI.getAgency();
//         console.log("✅ Agency data loaded:", agencyRes.data);
//         setAgency(agencyRes.data);
//       } catch (agencyError) {
//         console.warn("⚠️ Could not fetch agency data:", agencyError.message);

//         // Use default agency data for invoices
//         const defaultAgency = {
//           name: "Travel Agency",
...
//         // Show warning toast only if not in production
//         if (import.meta.env.DEV) {
//           toast("Using default agency data for invoices", {
//             icon: "ℹ️",
//             duration: 3000,
//           });
//         }
...
//     // ✅ FIXED: Get original service price
...
//   // FIXED: buildBookingPayload function
...
//     // FIXED LINE: Yeh check karo ke notes string hai ya nahi
//     payload.notes =
...
//   // ✅ CORRECTED: validateForm function with proper travel logic
//   const validateForm = () => {
//     const errors = {};
...
//     // ✅ TRAVEL LOGIC: Arrival (return) should be AFTER departure (travel)
//     if (formData.arrival_date && formData.departure_date) {
//       const departure = new Date(formData.departure_date);  // Travel date
//       const arrival = new Date(formData.arrival_date);      // Return date
...
//       // Return date (arrival) cannot be before travel date (departure)
...
//   // FIXED: handlePaymentUpdate function
...
//         // FIXED: Yeh bhi check karo ke notes string hai ya nahi
//         notes:
...
//             ref={searchInputRef}
//             type="text"
//             placeholder="Search by Booking ID, Client Name, or Phone..."
//             value={searchTerm}
...
//             Tip: Search by Booking ID (e.g., "123"), Client Name, or Phone
//             Number
//           </p>
//           {searchQuery && (
...
//                   if (missingOnly) setMissingOnly(false);
//                 }}
...
//                 {/* ✅ UPDATED: Corrected date labels and validation */}
//                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//                   <div>
//                     <label className="block text-sm font-medium text-gray-700 mb-2">
